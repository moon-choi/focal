...
export const preparePlayerData = (playerData) => {
  ...
  // [ { gamerTag: "Disguised Lizard", firstName: "Daria", lastName: "Stark" } , <- each of them is "player"
  //   { gamerTag: "DrSpiteful", firstName: "Terrell" , lastName: "Hunter"  },
  //  ...
  // ] <- we are adding player.wins newly in the function below.
}
